...
Recuerda que todas tus versiones salen de la rama principal o main y de allí puedes tomar una versión específica para crear otra rama de versiones.

## Cómo hacer merge
Producir una nueva rama se conoce como Checkout. Unir dos ramas lo conocemos como Merge.

Cuando haces merge de estas ramas con el código principal, su código se fusiona originando una nueva versión de la rama main que ya tiene todos los cambios que aplicaste en tus experimentos o arreglos de errores.
