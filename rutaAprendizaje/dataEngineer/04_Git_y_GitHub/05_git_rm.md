...
$ git reset --soft
```
Borra todo el historial y los registros de Git pero guardamos los cambios que tengamos en Staging, así podemos aplicar las últimas actualizaciones a un nuevo commit.

```
$ git reset --hard
```
Borra todo. Toda la información de los commits y del área de staging se borra del historial.
